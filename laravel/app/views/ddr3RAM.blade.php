        ...
        <?php
            ...
            else
            {
                ...
                foreach($products->xpath('//Product') as $product)
                {
                    ...
                    "<img src='$image' alt='ddr3 ram logo'>",
                    "</a>",
