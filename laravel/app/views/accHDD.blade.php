...
<html>
    ...
    <body>
        <div class="container">
        <h1>Hard Drive Accessories</h1>

        <?php

            $name = 'accHDDProductDetails';
            
            $image = 'http://www.soarland.com/shared/images/product/SLA001_SATA_DATA_CABLE.jpg';
        
            $target_url = 'http://b2b.alsolatvia.lv/DirectXML.svc/2/scripts/XML_Interface.dll?MfcISAPICommand=Default&USERNAME=XmlNTuser623&PASSWORD=NTxMl262PiedzUser&XML=<?xml%20version="1.0"%20standalone="yes"?><CatalogRequest%20xmlns="urn:XMLLink:eLinkCatalog"><Date>2000-12-27T12:55:46</Date><CatNumber>1.0</CatNumber><Route><From><ClientID>10726237</ClientID></From><To><ClientID>0</ClientID></To></Route><Filters><Filter%20FilterID="ClassID"%20Value="L03003005"/><Filter%20FilterID="Price"%20Value="WOVAT"/></Filters></CatalogRequest>&CHECK=12345';
            ...
            else
            {
                ...
                foreach($products->xpath('//Product') as $product)
                {
                    ...
                    "<img src='$image' alt='hdd accessories logo'>",
                    "</a>",
